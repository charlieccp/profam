...
def load_named_model(model_name, overrides=None):
    ...
    tokenizer_cfg['tokenizer']['max_res_pos_in_seq'] = model_cfg.model.max_res_pos_in_seq
    tokenizer_cfg['tokenizer']['embed_residue_index'] = model_cfg.model.embed_residue_index
