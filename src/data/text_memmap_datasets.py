...
class TextMemMapDataset(torch.utils.data.Dataset):
    """
    ...
    def __init__(
        ...
        Args:
            ...
            local_rank: local rank of the process. If None, it is ignored.
        """
        super().__init__()
        ...
        logger.info(f"Building data files")
        ...
        if is_distributed and self.local_rank == 0:
    ...
    def __getitem__(self, idx):
        ...
        file_id = bisect_right(self.midx_bins, idx)
